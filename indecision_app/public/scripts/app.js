...
var Traveller = function (_Person2) {
  ...
  _createClass(Traveller, [{
    key: "getGreeting",
    value: function getGreeting() {
      var getGreeting = _get(Traveller.prototype.__proto__ || Object.getPrototypeOf(Traveller.prototype), "getGreeting", this).call(this);
      if (this.homeloc) {
...
var me = new Traveller("Shaurya", 18, "JBL");
var me1 = new Student();
